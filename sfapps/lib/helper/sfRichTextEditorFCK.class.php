...
class sfRichTextEditorFCK extends sfRichTextEditor
{
  ...
  public function toHTML()
  {
    ...
    //echo sfConfig::get('sf_rich_text_fck_js_dir'); die();
...
/*    $ckfinder_upload_url = _compute_public_path('', 'uploads/extras/', '');
    setcookie('ckfinder_upload_url', $ckfinder_upload_url, time()+3600, '/');

    $ckfinder_upload_path = sfConfig::get('sf_upload_dir').DIRECTORY_SEPARATOR.'extras/';
    setcookie('ckfinder_upload_path', $ckfinder_upload_path, time()+3600, '/');
